                ...
                with open(benchmark_path) as file:
                    ...
                    for line in file: # read addresses line by line
                        ...
                        if missed:
                            ...
                            prefetch(cache, pred1_mm_block_number, pred1_set_number, policy)
                            prefetch(cache, pred2_mm_block_number, pred2_set_number, policy)
                            prefetch(cache, pred3_mm_block_number, pred3_set_number, policy)
