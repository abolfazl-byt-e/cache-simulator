            ...
            for policy in replacement_policies:
                ...
                with open(benchmark_path) as file:
                    ...
                    for line in file: # read addresses line by line
                        ...
                        cache, hit_count, miss_count = lookup(cache, mm_block_number, set_number, policy, hit_count, miss_count)
                        ''' stride prefetching...'''
                        ...
                        if value != None:
                            ...
                            if last_stride == current_stride:
                                ...
                                cache = prefetch(cache, pred_next_block, pred_set_number, policy)
                            else:
                                # update_RPT
